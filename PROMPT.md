...
install cap, bind it to every harness it finds on your machine, and report back
in plain language. You don't need to know anything about terminals.

---

```text
Install the open-source tool "cap" on this machine, then verify it works.
...
2. Clone the repo into my home directory:
   git clone https://github.com/Hannay001/cap.git ~/cap
...
After this, `cap` is on your PATH and bound to every agent on your machine.
Ask your agent: *"run cap doctor"* any time you want to see the current state.
